...
.task-row { min-width: 0; overflow: hidden; }
.task-row__date { width: 72rpx; height: 80rpx; min-width: 72rpx; flex: 0 0 72rpx; box-sizing: border-box; overflow: hidden; }
.task-row__date > text { width: 100%; display: block; font-weight: 800; line-height: 1; text-align: center; font-variant-numeric: tabular-nums; }
.task-row__date > .small { margin-top: 7rpx; font-size: 17rpx; font-weight: 600; line-height: 1; }
.task-row__copy { overflow: hidden; }
.task-row__copy .small { max-width: 100%; font-size: 18rpx; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.task-row :deep(.smis-status-tag) { flex: 0 0 auto; }
</style>
